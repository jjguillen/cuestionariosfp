...
@section('title', 'POLÍTICA DE PRIVACIDAD Y AVISO LEGAL')
...
<p>
NOMBRE: Javier Guillén Benavente <br>
DNI: 48416709F <br>
DOMICILIO: C/ Zurbarán 1, Mojácar (Almería) <br>
E-MAIL: jjavierguillen@gmail.com <br>
</p>

<h3>3. PRINCIPIOS CLAVE</h3>

<p><strong>Legalidad:</strong> Solo recopilaremos sus Datos personales para fines específicos, explícitos y legítimos. </p>
<p><strong>Minimización de datos:</strong> Limitamos la recogida de datos de carácter personal a lo que es estrictamente relevante y necesario para los fines para los que se han recopilado. </p>
<p><strong>Limitación de la Finalidad:</strong> Solo recogeremos sus datos personales para los fines declarados y solo según sus deseos. </p>
<p><strong>Precisión:</strong> Mantendremos sus datos personales exactos y actualizados. </p>
<p><strong>Seguridad de los Datos:</strong> Aplicamos las medidas técnicas y organizativas adecuadas y proporcionales a los riesgos para garantizar que sus datos no sufran daños, tales como divulgación o acceso no autorizado, la destrucción accidental o ilícita o su pérdida accidental o alteración y cualquier otra forma de tratamiento ilícito. </p>
<p><strong>Acceso y Rectificación:</strong> Disponemos de medios para que acceda o rectifique sus datos cuando lo considere oportuno. </p>
<p><strong>Conservación:</strong> Conservamos sus datos personales de manera legal y apropiada y solo mientras es necesario para los fines para los que se han recopilado. </p>
<p><strong>Las transferencias internacionales:</strong> en ningún caso se producirá esta situación. </p>
<p><strong>Terceros:</strong> No se cederá ningún dato a terceros. Únicamente la empresa donde están alojados los datos tendrá acceso a ellos. <br>
El acceso y transferencia de datos personales a terceros se llevan a cabo de acuerdo con las leyes y reglamentos aplicables y con las garantías contractuales adecuadas. </p>
<p><strong>Marketing Directo y cookies:</strong> Cumplimos con la legislación aplicable en materia de publicidad y cookies. <br>

<h3>4. RECOGIDA Y TRATAMIENTO DE SUS DATOS PERSONALES</h3>

<p>Las tipos de datos que se pueden solicitar y tratar son:</p>

<p>- Datos de de carácter identificativo.</p>
...
<p>Siempre que solicitemos sus Datos personales, le informaremos con claridad de qué datos personales recogemos y con qué fin. En general, recogemos y tratamos sus datos personales con el propósito de:</p>
	<p>- Sondear intereses de matriculación en FP</p>
	<p>- Enviar publicidad a aquellos alumnos que muestren interés por algún ciclo formativo del IES Jaroso</p>
...
- Por se necesaria para la prestación de alguno de nuestros servicios mediante relación contractual entre usted y nosotros. <br>

<h3>6. COMUNICACIÓN DE DATOS PERSONALES</h3>

<p>Los datos pueden ser comunicados a profesores del IES Jaroso para la extracción de información relativa a intereses del alumnado. No realizaremos ninguna cesión, salvo por obligación legal.</p>
...
<p>Puede ejercer estos derechos enviando comunicación, motivada y acreditada, a jjavierguillen@gmail.com</p>
...
<p>No recopilamos ninguna cookie</p>
